        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl bg-stone-50 border border-stone-200">
              ...
              <div className="w-full mt-6 py-2 rounded-xl border border-stone-200 font-bold text-sm text-center bg-stone-100 text-stone-400 uppercase tracking-widest text-[10px]">Current Plan</div>
            </div>
